...
<html>
  ...
  <body style="background-color:#000;">
    <form class="myloginform" method="post" action="">
      <div>
        <a href="../index.php"><img src="../Images/CenPharma_Logo.png" style="display:block; width:70%; margin-left: auto;margin-right: auto;"></a>
      </div>
      ...
      <a href="../login.php" style="color:white">User Login</a>
    </form>
  </body>
</html>
