  ...
  <body>
    <section id="home1" style="background-color:#000;">
      ...
      ?>
        ...
        <br />
        <h1 class="cwhite" style="text-decoration:none; color:#6bf;">Medline Plus</h1>
        <h4 class="cwhite fw400" style="text-decoration:none; color:#6bf;">Medicines delivered fast!</h4>
        <br />
        <h4 class="fw400"><a style="text-decoration:none; color:#6bf;" href="./medicine">Order Now ></a></h4>
    </section>
    <section id="home2">
      <div style="text-align:center; padding-top:20px; padding-bottom:20px;">
        <h3 class="pt-2 pb-2">Why Medline Plus?</h3>
        <p class="desc pb-2">
      ...
      <div class="row mb-2" style="justify-content: center;">
        <div class="sixcol">
          <div class="card homecard zoom" style="justify-content: center;">
            <div>
              <img src="Images/products/CPP1107.jpg" class="home-prod-image ">
            </div>
      ...
      <div class="container ml-2 mr-2">
        <div class="row mb-2">
          <div class="quarcol">
            <div class="card homecard zoom" style="justify-content: center;">
              <div>
                <img src="Images/categories/CPC927.png" class="home-card-image ">
              </div>
          ...
          <div class="quarcol">
            <div class="card homecard zoom" style="justify-content: center;">
              <div>
                <img src="Images/categories/CPC1423.png" class="home-card-image ">
              </div>
          ...
          <div class="quarcol">
            <div class="card homecard zoom" style="justify-content: center;">
              <div>
                <img src="Images/categories/CPC2031.png" class="home-card-image ">
              </div>
          ...
          <div class="quarcol">
            <div class="card homecard zoom" style="justify-content: center;">
              <div>
                <img src="Images/categories/CPC3002.png" class="home-card-image ">
              </div>
    ...
    <section id="home2">
      <div style="text-align:center; padding-top:20px; padding-bottom:20px;">
        <h3 class="pt-2 pb-2">Team Medline Plus</h3>
        <p class="desc pb-2">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
        </p>
      </div>
      <div class="container mr-5 ml-5">
        <div class="row" style="justify-content:center;">
          <div class="col4">
            <div class="card white" style="justify-content:center; padding-top:0px;">
              <div class="box">
                <img class="round-circle-img-home"src="Images/Home/IMG_6723.jpg" />
                <h4 class="fw600" style="margin-bottom:5px;">Mohit Kumar</h4>
