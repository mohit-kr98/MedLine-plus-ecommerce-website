...
<main id="maincontent" role="main" class="content-vw">
	<div class="container">
		<div class="page-content">
			...
			<div class="more-btn">
		        <a href="<?php echo esc_url(home_url()); ?>"><?php echo esc_html(get_theme_mod('automotive_centre_404_page_button_text',__('GO BACK','automotive-centre')));?><span class="screen-reader-text"><?php esc_html_e( 'GO BACK','automotive-centre' );?></span></a>
		    </div>
		</div>
